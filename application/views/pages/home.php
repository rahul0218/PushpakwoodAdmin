  ...
  <div class="banner-carousel-item" style="background-image:url(assets/images/slider-main/bg2.jpg)">
    <div class="slider-content text-left">
        <div class="container h-100">
          <div class="row align-items-center h-100">
              <div class="col-md-12">
                <h2 class="slide-title-box" data-animation-in="slideInDown">World Class Products</h2>
  ...
  <div class="banner-carousel-item" style="background-image:url(assets/images/slider-main/bg3.jpg)">
    <div class="slider-content text-right">
        <div class="container h-100">
          <div class="row align-items-center h-100">
              <div class="col-md-12">
                <h2 class="slide-title" data-animation-in="slideInDown">Meet Our Team</h2>
        ...
        <div class="row align-items-center">
          <div class="col-md-8 text-center text-md-left">
              <div class="call-to-action-text">
                <h3 class="action-title">We understand your needs on plywood</h3>
              </div>
          </div><!-- Col end -->
        ...
        <div class="col-lg-4">
          <div class="ts-service-box d-flex">
              ...
              <div class="ts-service-box-info">
                <h3 class="service-box-title"><a href="#">Home plywood</a></h3>
